...
class LibUserTest
{
    ...
    @Test
    void testBorrowItem() throws LibUserException, NoSuchFieldException, IllegalAccessException {
    ...
    @Test
    void testReturnItem() throws LibUserException, NoSuchFieldException, IllegalAccessException {
        givenUserValidArguments();
        Book book = new Book("Title1", true, "Author", "1111111111111", "11111111-1111-1111-1111-111111111111");
